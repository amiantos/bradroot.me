...
export class BradrootMeStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const bucket = new s3.Bucket(this, "BradRootWebsiteBucket", {
      bucketName:  'bradroot-website',
      blockPublicAccess: s3.BlockPublicAccess.BLOCK_ALL,
      publicReadAccess: false,
      removalPolicy: cdk.RemovalPolicy.DESTROY,
    });

    const distribution = new cloudfront.Distribution(this, "BradRootWebsiteDistribution", {
      defaultBehavior: {
